...
```
Upper secondary Female completion and upper secondary completion for mens has the most impact, due to having the largest
abs value.
...
### Question 8 - NOT FINISHED (p sure this is optinal)
